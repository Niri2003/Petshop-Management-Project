...
<table border="1">
    ...
    $sql = "SELECT * FROM paymenthostel
        INNER JOIN hostelbooking ON paymenthostel.Hostel_Bid = hostelbooking.Hostel_Bid
        WHERE hostelbooking.User_id = '$id'";
...
<table border="1">
    ...
    $gsql = "SELECT * FROM paymentgrooming
         INNER JOIN groomingbooking ON paymentgrooming.Grooming_Bid = groomingbooking.Grooming_Bid
         WHERE groomingbooking.User_id = '$id'";
